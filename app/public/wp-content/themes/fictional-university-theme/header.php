      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            -->
          <ul>
              <li <?php if (is_page('about-us') || wp_get_post_parent_id(0) == get_page_by_path('about-us')->ID) echo 'class="current-menu-item"'; ?>><a href="<?php echo site_url('/about-us'); ?>">About Us</a></li>
